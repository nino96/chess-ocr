...
Local evaluation only; no model release/publication is approved. The repository's
original source is licensed under MIT; the npm package remains explicitly private
until a separate publication decision is made.
