...
the owning issues/dependencies, and ignored work/dataset/bootstrap/ handoff records.
...
services, private upload, permission outreach or publication is part of the plan.
...
run a catch-all upstream asset fetcher. All original assets and metadata stay ignored.
